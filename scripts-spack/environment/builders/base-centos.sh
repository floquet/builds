...
echo "spack install py-pyaml ${myCompiler} ${myPython}  2>&1 | tee -a ${mySpackLogs}/py-pyaml.txt" >> py-urllib3.txt
      spack install py-pyaml ${myCompiler} ${myPython}  2>&1 | tee -a ${mySpackLogs}/py-pyaml.txt
