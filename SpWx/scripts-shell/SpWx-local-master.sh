...
# source /repos/github/builds/SpWx/scripts-shell/SpWx-local-master.sh 2>&1 | tee -a ${HOME}/SpWx-local-master-dialog.txt
...
sub_step_counter=0
    ...
    sub_step 'export localSpWx="${scratch}/SpWx-master"'
              export localSpWx="${scratch}/SpWx-master"
...
new_step "Output stream is in ${HOME}/SpWx-local-master-dialog.txt"
