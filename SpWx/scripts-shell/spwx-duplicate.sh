...
# source /repos/github/builds/SpWx/scripts-shell/spwx-duplicate.sh 2>&1 | tee -a ${scratch}/spwx-duplicate.txt
...
sub_step_counter=0
    ...
    sub_step "cp -a /Tlaloc/SpWx ${scratch}"
              cp -a /Tlaloc/SpWx ${scratch}
