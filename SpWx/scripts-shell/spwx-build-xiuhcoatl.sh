...
# source         /repos/github/builds/SpWx/scripts-shell/spwx-build-xiuhcoatl.sh 2>&1 | tee -a ${scratch}/spwx-build-xiuhcoatl.txt
# source /Volumes/repos/github/builds/SpWx/scripts-shell/spwx-build-xiuhcoatl.sh 2>&1 | tee -a ${scratch}/spwx-build-xiuhcoatl.txt
...
new_step "Update the SpWx source directory in ${scratch}"
sub_step_counter=0
...
new_step "mv ${scratch}/spwx-build-xiuhcoatl.txt ${scratch}/$(uname -n)-${ymdtf}-spwx-build-xiuhcoatl.txt"
          mv ${scratch}/spwx-build-xiuhcoatl.txt ${scratch}/$(uname -n)-${ymdtf}-spwx-build-xiuhcoatl.txt

new_step "Output stream is in ${scratch}/$(uname -n)-${ymdtf}-spwx-build-xiuhcoatl.txt"
